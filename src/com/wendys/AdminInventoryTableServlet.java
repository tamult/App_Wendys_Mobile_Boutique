...
@WebServlet(
		description = "AdminInventoryTableServlet",
		urlPatterns = { "/InventoryTable" }
		)
public class AdminInventoryTableServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public AdminInventoryTableServlet() {
        super();   
    }
